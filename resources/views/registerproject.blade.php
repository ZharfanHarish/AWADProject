        ...
        <div class="col-md-11">
            <div class="card">
                ...
                <form method="POST" action="{{ route('project.store') }}">
                    ...
                    <input type="text" id="title" name="title" placeholder="Project title here"><br><br>
                    ...
                    <input type="number" id="duration_in_month" name="duration_in_month" placeholder="Duration here"><br><br>
